...
MODELS = {
    ...
    "RandomForestClassifier2": lambda: sklearn.ensemble.RandomForestClassifier(n_estimators=10),
    "RandomForestClassifier3": lambda: sklearn.ensemble.RandomForestClassifier(n_estimators=1000),
    "RandomForestClassifier4": lambda: sklearn.ensemble.RandomForestClassifier(max_features=None),
    "RandomForestClassifier5": lambda: sklearn.ensemble.RandomForestClassifier(max_features="log2"),
    "RandomForestClassifier6": lambda: sklearn.ensemble.RandomForestClassifier(min_samples_leaf=10),
    "RandomForestClassifier7": lambda: sklearn.ensemble.RandomForestClassifier(min_samples_leaf=50),
